...
export default {
    ...
    methods: {
        ...
        load_assets() {
            ...
            //         let root = meshes[0];
            //         root.position.x = -5
            //         this.mesh_list.set('root', meshes[0]);
            //         this.mesh_list.set('left_ear', meshes[3]);
            //     }
            // );
            // BABYLON.SceneLoader.ImportMesh(
            //     "",
            //     'assets/',
            //     "submeshes_test_2.glb",
            //     this.scene,
            //     (meshes, particleSystems, skeletons, animationGroups) => {
            //
            //         let root = this.mesh_list.get('root');
            //         let left_ear = this.mesh_list.get('left_ear');
            //         left_ear.position.y = 2
            //         root.removeChild(left_ear)
            //         let bleu_left_ear = meshes[3];
            //
            //         bleu_left_ear.translate(new BABYLON.Vector3(-5, 0, 0), 1, BABYLON.Space.WORLD)
            //
            //         root.addChild(bleu_left_ear)
            //         root.position.y = -1
            //         root.position.x = -4
            //         root.rotation = new BABYLON.Vector3(0, (Math.PI/2)*4, 0)
            //
            //     }
            // );
        },
        ...
        success(meshes, particleSystems, skeletons, animationGroups) {
            ...
            this.mesh_list.set(meshes[2].name, meshes[2])
    ...
    watch: {
        asset_loaded() {
            if (this.asset_loaded === 1){
                if (this.asset_loaded) {
